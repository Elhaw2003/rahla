...
import 'package:travel_app/features/user/home/presentation/widgets/home_shimmer_loading.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AppButton(text: 'إعادة المحاولة', onPressed: _onRefresh),
          ],
        ),
      ),
    );
        ...
        return BlocBuilder<CategoriesCubit, CategoriesStates>(
          builder: (context, categoriesState) {
            ...
            if (categoriesState is CategoriesFailure) {
              return _buildError(categoriesState.message);
            }

            final success = homeState is HomeSuccess ? homeState : null;
